...
namespace WindowsFormsApp1
{
    public partial class Form5 : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "fnsDataSet1.RICUSN". При необходимости она может быть перемещена или удалена.
            this.rICUSNTableAdapter.Fill(this.fnsDataSet1.RICUSN);
