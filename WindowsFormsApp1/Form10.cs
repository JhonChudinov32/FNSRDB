...
namespace WindowsFormsApp1
{
    public partial class Form10 : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "fnsDataSet4.PRAVONAR". При необходимости она может быть перемещена или удалена.
            this.pRAVONARTableAdapter.Fill(this.fnsDataSet4.PRAVONAR);
        }
    }
}
